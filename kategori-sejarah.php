...
$wisata = query("SELECT * FROM menu_wisata WHERE kategori='sejarah'");
?>
...
<body>
	...
	<!-- END nav -->
	<div class="sejarah-hero-wrap">
		<div class="kategori-overlay">
		</div>
		<div class="container wisata-section">
			<div class="row justify-content-start mb-5 pb-3">
				<div class="col-md-7 breadcrumb-section">
						<span><a href="index.php">Home </a> / Wisata Sejarah</span>
					</div>
				</div>
				<h1 class="headline-wisata">Wisata Sejarah</h1>
