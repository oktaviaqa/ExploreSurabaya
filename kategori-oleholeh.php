...
$wisata = query("SELECT * FROM menu_wisata WHERE kategori='pusatoleh'");
?>
...
<body>
	...
	<!-- END nav -->
	<div class="hero-wrap" style="background-image: url('assets/images/pusat oleh/bg-pusat.jpg');height: 50vh;">
		<div class="container wisata-section">
			<div class="row justify-content-start mb-5 pb-3">
				<div class="col-md-7 breadcrumb-section">
						<span><a href="index.php">Home </a> / Pusat Oleh-oleh</span>
					</div>
				</div>
				<h1 class="headline-wisata">Pusat Oleh-oleh</h1> 
								...
								<div class="destination">
									...
									<div class="text p-3" style="height: 300px; border-radius: 0 0 20px 20px ;">
										...
										<p class="bottom-area d-flex">
											...
											<span class="ml-auto"><a href='rute.php?lat=<?= $row["lat"]; ?>&lng=<?= $row["lng"]; ?>'>Kunjungi</a></span>
										</p>
									</div>
								</div>
							</div>
