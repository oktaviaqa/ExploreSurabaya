...
$wisata = query("SELECT * FROM menu_wisata WHERE kategori='keluarga'");
?>
		...
		<div class="container wisata-section">
			<div class="row justify-content-start mb-5 pb-3">
				<div class="col-md-7 breadcrumb-section">
					<span><a href="index.php">Home </a> / Wisata Keluarga</span>
				</div>
			</div>
			<h1 class="headline-wisata">Wisata Keluarga</h1>
